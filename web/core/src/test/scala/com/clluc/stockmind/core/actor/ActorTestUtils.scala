...
object ActorTestUtils {
  ...
  abstract class ActorTest(actorSystemName: String)
  ...
  trait CommonFixture {
    ...
    val loggedEvent1 = LoggedEvent(
      ...
      EthereumHash
        .decodePrefixedHexString(
          "0x628e89e3e2bbbc88a34df624dd600f66b121c9c9c5a972d1ef6823da1a2a12c5")
        .get,
      0,
      EthereumHash
        .decodePrefixedHexString(
          "0x628e89e3e2bbbc88a34df624dd600f66b121c9c9c5a972d1ef6823da1a2a12c3")
        .get
    )
    ...
    val loggedEvent2 = LoggedEvent(
      ...
      EthereumHash
        .decodePrefixedHexString(
          "0x8cba3bd5974fb91398f3e6bcaa9d5fdfb7d08fdab607518b672ae8de77200b62")
        .get,
      0,
      EthereumHash
        .decodePrefixedHexString(
          "0x8cba3bd5974fb91398f3e6bcaa9d5fdfb7d08fdab607518b672ae8de77200b65")
        .get,
    )
